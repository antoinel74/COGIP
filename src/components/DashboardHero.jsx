    ...
    <div className="relative mb-8">
      ...
      <div className="h-1/2 bg-[#9798d6] rounded">
        <div className="w-full md:w-[50%] p-8 text-white">
          ...
          <p className="font-light mt-2 text-sm">You can here add an invoice, a company and some contacts</p>
        </div>
        <figure className="hidden md:block w-1/2 h-full absolute top-0 right-0">
          <img src="/img/dash-scene.png" className="w-full h-full object-contain"></img>
        </figure>
      </div>
    </div>
  );
